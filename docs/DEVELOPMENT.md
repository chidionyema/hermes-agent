# Hermes Agent - Development Reference

Full technical detail moved here from `AGENTS.md`. The pointer file (`AGENTS.md`) contains
the quick-reference rules; this document contains the full prose.

---

## Contribution Rubric — Full Text
...
this is a coupling decision, not a quality judgment.
