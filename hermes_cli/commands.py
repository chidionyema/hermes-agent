...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("code", "Open a coding-agent session on a repo — this chat becomes the terminal",
               "Session", gateway_only=True, aliases=("cc",),
               args_hint="[<repo> [claude|pi] | end | status]",
               subcommands=("end", "status")),
    ...
    CommandDef("lanes", "Open work by lane and priority, live from GitHub", "Info",
               args_hint="[engine|api|ui|ops]",
               subcommands=("engine", "api", "ui", "ops"),
               gateway_only=True),
